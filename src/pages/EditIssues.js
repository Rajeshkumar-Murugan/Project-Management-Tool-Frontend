...
function EditIssues() {
  ...
  let [IssueScreen,setIssueScreen]= useState("");
   ...
   let getData = async()=>{
    try {
        ...
        setIssueScreen(Editvalues.IssueScreen)
    } catch (error) {
  ...
  return <div >
    ...
    <div className='container-fluid' style={{background: "bisque"}}>
      ...
      <input type="text" value={IssueTitle} className="form-control" id="Image_1" onChange={(e)=>setIssueTitle(e.target.value)}/>
        ...
        <div className="col-md-12 formfields">
          <label htmlFor="Width" className="form-label">Issue Screenshot</label>
          <input type="text" value={IssueScreen} className="form-control" id="Width" onChange={(e)=>setIssueScreen(e.target.value)}/>
        </div>
