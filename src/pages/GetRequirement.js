...
:<div>
      ...
      <table className="table">
                <thead>
                    ...
                    <th scope="col" className='col-1'>Milestone</th>
           ...
           data.map((e,i)=>{
             return<>
              <tr>
                     ...
                     onClick={()=>(setReqTitle(e.ReqTitle),setCreatedBy(e.CreatedBy),setReqDesc(e.ReqDes),setImage(e.MockupScreen))}
                     >
                       {e.ReqTitle}</a></td>
                     <td>{e.Milestone}</td>
                     <td>{e.DeadLine}</td>
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <hr/><br/>
                <h4>Mock Screenshot</h4>
                <img src={Image} class="img-fluid" alt="Requirement Mockup"/>
