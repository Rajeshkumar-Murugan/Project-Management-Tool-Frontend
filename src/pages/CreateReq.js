          ...
          <div className="col formfields">
            ...
            <div className="col formfields">     
              ...
              <label htmlFor="Milestone">Milestone</label>
                <input id="Milestone" name="Milestone" type="text"
                  className="form-control" placeholder='Enter Milestone'
                  onChange={formik.handleChange}
                  value={formik.values.Milestone}/>
                  {formik.touched.Milestone && formik.errors.Milestone?(<div style={{color:"red"}}>{formik.errors.Milestone}</div>
                  ):null}
             </div>
